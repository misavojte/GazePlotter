...
import { EyeTrackingParserGazePointReducer } from '../src/ts/Back/EyeTrackingParser/Reducer/EyeTrackingParserGazePointReducer'
...
const separator = ','
const header = 'MEDIA_ID,MEDIA_NAME,TIME(2021/07/13 09:21:09.801),FPOGS,FPOGD,FPOGID,BKID,BKDUR,AOI,'.split(separator)

const fixRow1 = '0,Slide0,0.06689,0.00000,0.06689,1,0,0.00000,,'.split(separator)
const fixRow2 = '0,Slide0,0.13378,0.06689,0.06689,2,0,0.00000,,'.split(separator)

const rawRow1 = '2,Slide01,1.52063,1.38635,0.13428,6,0,0.00000,Right-AOI 4,'.split(separator)
const rawRow2 = '2,Slide01,1.54968,1.38635,0.16333,6,0,0.00000,Right-AOI 4,'.split(separator)
const rawRow3 = '2,Slide01,1.57410,1.38635,0.16333,6,157,0.00000,,'.split(separator)
const rawRow4 = '2,Slide01,1.71008,1.38635,0.16333,6,0,0.13605,,'.split(separator) // with blink dur info
const rawRow5 = '2,Slide01,1.74805,1.72827,0.01978,7,0,0.00000,Right-AOI 4,'.split(separator)
const rawRow6 = '2,Slide01,1.91528,1.72827,0.18701,7,0,0.00000,Right-AOI 4,'.split(separator)
const rawRow7 = '2,Slide01,1.92200,1.72827,0.18701,7,0,0.00000,,'.split(separator)
const rawRow8 = '2,Slide01,1.93200,1.72827,0.18701,7,0,0.00000,,'.split(separator)
const rawRow9 = '2,Slide01,1.94200,1.93200,0.10000,8,0,0.00000,,'.split(separator)
