...
For exporting data and workspaces, see the dedicated [Export section](/docs/export/) which covers workspace export, segmented data export, and ScanGraph integration.
