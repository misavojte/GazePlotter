...
User data is then exported into multiple CSV format of two types, XXXX-user.csv and XXXX-user-fix.csv. To GazePlotter, only the XXXX-user.csv file is important - select all of them after clicking `Upload data` button (see [Workspace & Setup overview](/docs/workspace/)).
