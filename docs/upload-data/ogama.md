...
Select the exported file after clicking `Upload data` button (see more information in [Workspace & Setup overview](/docs/workspace/)) in to start the upload and visualization.
