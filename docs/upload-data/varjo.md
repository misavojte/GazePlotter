...
Multiple files are created during the recording. To GazePlotter, only the `gaze.csv` file is important - select it after clicking `Upload data` button (see [Workspace & Setup overview](/docs/setup/)).
