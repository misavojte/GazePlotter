...
- **Export Data**: To export the windowed values per participant as CSV, select the windowed metric in the [Metric Data Export](/docs/export/metric-data/) (long format).
