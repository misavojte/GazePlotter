 ...
 */
export declare const IDENTIFIER_IS_AOI: string;
export declare const IDENTIFIER_IS_OTHER_CATEGORY: string;
export declare const IDENTIFIER_NOT_DEFINED: string;
