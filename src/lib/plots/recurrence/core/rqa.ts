import type { RecurrenceHighlight, RecurrenceMasking, RQAMetrics } from '../types'
...
/**
 * Build a full NxN highlight mask from a recurrence matrix.
 * Combines upper/lower triangle logic with direction-specific line masks.
 * Returns null when highlight is 'none'.
 */
