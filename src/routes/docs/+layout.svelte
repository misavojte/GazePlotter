...
<style>
  ...
  /* Callouts — shared base */
  :global(.prose-wrapper .callout) {
    display: flex;
    flex-direction: column;
    gap: 0.4rem;
  ...
  :global(.prose-wrapper .callout > :first-child) {
    margin-top: 0;
  }

  :global(.prose-wrapper .callout > :last-child) {
    margin-bottom: 0;
  }

  :global(.prose-wrapper .callout-title) {
    font-weight: 700;
    font-size: 0.95rem;
    margin-bottom: 0.15rem;
  }

  :global(.prose-wrapper .callout ul) {
    list-style: none;
    padding-left: 0.25rem;
  }

  :global(.prose-wrapper .callout ul li) {
    padding-left: 1.5rem;
    position: relative;
  }

  /* Tip variant */
  :global(.prose-wrapper .callout.tip) {
    background-color: rgba(0, 127, 255, 0.08);
    border-left-color: rgba(0, 127, 255, 0.5);
  }

  :global(.prose-wrapper .callout.tip .callout-title) {
    color: rgba(0, 100, 200, 1);
  }

  :global(.prose-wrapper .callout.tip strong) {
    color: rgba(0, 100, 200, 1);
  }

  /* Warning variant */
  :global(.prose-wrapper .callout.warning) {
    background-color: rgba(245, 158, 11, 0.08);
    border-left-color: rgba(245, 158, 11, 0.6);
  }

  :global(.prose-wrapper .callout.warning .callout-title) {
    color: #b45309;
  }

  :global(.prose-wrapper .callout.warning strong) {
    color: #b45309;
  }

  :global(.prose-wrapper .callout.warning ul li::before) {
    color: #d97706;
  }
