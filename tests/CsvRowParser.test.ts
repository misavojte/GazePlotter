/**
 * Vitest tests for CsvRowParser
 *
 * @module CsvRowParser
 * @see $lib/data/ingest/formats/lib/rows/CsvRowParser.ts
 */

import { CsvRowParser } from '$lib/data/ingest/formats/lib/rows/CsvRowParser'
...
describe('CSV Deserializer - Multiple data', async () => {
  test('Mock Data One', async () => {
    ...
    const sut = new CsvRowParser(header, ',')
