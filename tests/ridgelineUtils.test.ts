...
import { calculateIdealStripHeight, scanForDynamicStripHeight } from '$lib/plots/aoi-stream/utils/ridgelineUtils';
...
describe('Ridgeline Utilities', () => {
  ...
  describe('calculateIdealStripHeight', () => {
    it('should calculate correct height for single series at 100%', () => {
      ...
      const data = {
        series: [{ values: new Float32Array(10).fill(1), id: 1, label: 's1', color: 'red' }],
        binCount: 10,
        participants: 1
      } as any;
